	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			case 1:
				...
				result = bank.addCommercialCustomer( firstName, lastName, 
					balance, contactPersonName, contactPersonNumber);                
			...
			case 2:
				...
				result = bank.addPersonalCustomer( firstName, lastName, 
					balance, homePhone, workPhone);
			...
			case 10:	System.out.println("Application Terminated...");
			 		System.exit(0);
			break;
